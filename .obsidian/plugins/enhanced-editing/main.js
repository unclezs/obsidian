...
var en = {
    ...
    FunctionUpdate: 'Version 0.5.2 adds a bilingual interface between Chinese and English, abolition of the "Smart line" function, the conversion of English and Chinese punctuation features optimized for the "Repair error Punctuation" ...',
...
class editSettingsTab extends obsidian.PluginSettingTab {
    ...
    display() {
        ...
        */
        ...
        mdText.appendChild(document.createElement('br'));
        mdText.appendText('转换代码块「CTRL+ALT+C」∶将选文转为或去除 ```代码块``` 效果');
        mdText.appendChild(document.createElement('br'));
        ...
        */
        ...
        charText.appendChild(document.createElement('br'));
        charText.appendText('转换待办状态「CTRL+ALT+X」：转换选文行首的待办状态，顺序为 -[ x-!?><+] 效果');
        charText.appendChild(document.createElement('br'));
        ...
        lineText.appendChild(document.createElement('br'));
        lineText.appendText('添加间隔空格「CTRL+SHIFT+S」：在正文的汉字与字母之间批量添加空格，如 china 中国。');
        lineText.appendChild(document.createElement('br'));
